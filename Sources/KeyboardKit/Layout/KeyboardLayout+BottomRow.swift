...
//    }
    ...
    mutating func tryInsertBottomRowAction(
        ...
        itemRows.insert(item, before: action, inRow: bottomRowIndex)
    }
    ...
    mutating func tryInsertBottomRowAction(
        ...
        itemRows.insert(item, after: action, inRow: bottomRowIndex)
    }
    ...
    mutating func tryReplaceBottomRowAction(
        ...
        itemRows.replace(action, with: item, inRow: bottomRowIndex)
    }
}
